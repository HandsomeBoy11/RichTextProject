...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        ...
        if (wm == null) {
            return MyApplication.Companion.getInstance().getResources().getDisplayMetrics().widthPixels;
        }
    ...
    public static int getScreenHeight() {
        WindowManager wm = (WindowManager) MyApplication.Companion.getInstance().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return MyApplication.Companion.getInstance().getResources().getDisplayMetrics().heightPixels;
        }
        Point point = new Point();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            wm.getDefaultDisplay().getRealSize(point);
    ...
    public static float getScreenDensity() {
        return MyApplication.Companion.getInstance().getResources().getDisplayMetrics().density;
    }
    ...
    public static int getScreenDensityDpi() {
        return MyApplication.Companion.getInstance().getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static boolean isLandscape() {
        return MyApplication.Companion.getInstance().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) MyApplication.Companion.getInstance().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static boolean isTablet() {
        return (MyApplication.Companion.getInstance().getResources().getConfiguration().screenLayout
    ...
    private static void adaptScreen(final Activity activity,
        ...
        final DisplayMetrics appDm = MyApplication.Companion.getInstance().getResources().getDisplayMetrics();
